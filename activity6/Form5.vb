...
Public Class Form5
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        With Me
            ...
            Try
                strSQL = "Insert into author values('" _
                & .TextBox1.Text & "', '" _
                & .TextBox2.Text & "','" _
                & .TextBox3.Text & "','" _
                & .TextBox4.Text & "')"
                ...
                MsgBox("Author Successfully Added")
                Call Clear_Boxes()
    ...
    Private Sub SearchButton_Click(sender As Object, e As EventArgs) Handles SearchButton.Click
        ...
        With Me
            ...
            strSQL = "Select author_id, author_name, author_nationality, publisher_id from author where author_name = '" _
                    & .TextboxSearch.Text & "'"
            'MsgBox(strSQL)
            mycmd.CommandText = strSQL
            mycmd.Connection = myconn
            ...
            If myreader.HasRows Then
                ...
                End While
            Else
                MsgBox("The author you are searching for does not exist!")
            End If
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        With Me
            ...
            Dim mycmd As New MySqlCommand
            Try
                strSQL = "UPDATE author SET author_id = '" _
                & .TextBox1.Text & "', author_nationality = '" _
                & .TextBox3.Text & "', publisher_id = '" _
                & .TextBox4.Text & "', WHERE author_name = '" _
                & .TextBox2.Text & "'"
                mycmd.CommandText = strSQL
                mycmd.Connection = myconn
                mycmd.ExecuteNonQuery()
                MsgBox("Author Successfully Updated")
                Call Clear_Boxes()
            Catch ex As MySqlException
                MsgBox(ex.Number & " " & ex.Message)
            End Try
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        With Me
            ...
            Try
                ...
                answer = MsgBox("Are you sure you want to delete this author", MsgBoxStyle.YesNo)
                If answer = MsgBoxResult.Yes Then
                    strSQL = "Delete from author" _
                                    & " where author_name = '" _
                                    & .TextBox2.Text & "'"
                    'MsgBox(strSQL)
                    mycmd.CommandText = strSQL
                    mycmd.Connection = myconn
                    mycmd.ExecuteNonQuery()
                    MsgBox("Author Successfully Deleted")
                    Call Clear_Boxes()
                End If
    ...
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim adapter As New MySqlDataAdapter("SELECT * FROM lib_db.author", connection)
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        Dim table As New DataTable()
        Dim adapter As New MySqlDataAdapter("SELECT * FROM lib_db.author", myconn)
        ...
        If dlg.ShowDialog() = DialogResult.OK Then
            ...
            Using connection As New MySqlConnection(connectionString)
                ...
                For Each row As DataRow In dt.Rows
                    Dim insertSql As String = "INSERT INTO author ("
    ...
    Private Sub Button11_Click(sender As Object, e As EventArgs) Handles Button11.Click
        ...
        Using connection As New MySqlConnection(connectionString)
            ...
            Dim selectSql As String = "SELECT * FROM author"
