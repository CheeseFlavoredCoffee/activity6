...
Public Class Form4
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        With Me
            ...
            Try
                strSQL = "Insert into genre values('" _
                & .TextBox1.Text & "', '" _
                & .TextBox2.Text & "')"
                mycmd.CommandText = strSQL
                mycmd.Connection = myconn
                mycmd.ExecuteNonQuery()
                MsgBox("Genre Successfully Added")
                Call Clear_Boxes()
    ...
    Private Sub SearchButton_Click(sender As Object, e As EventArgs) Handles SearchButton.Click
        ...
        With Me
            ...
            strSQL = "Select genre_id, genre_name from genre where genre_name = '" _
                    & .TextboxSearch.Text & "'"
            'MsgBox(strSQL)
            mycmd.CommandText = strSQL
            mycmd.Connection = myconn
            ...
            If myreader.HasRows Then
                ...
                End While
            Else
                MsgBox("The genre you are searching for does not exist!")
            End If
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        With Me
            ...
            Dim mycmd As New MySqlCommand
            Try
                strSQL = "UPDATE genre SET genre_id = '" _
                & .TextBox1.Text & "', WHERE genre_name = '" _
                & .TextBox2.Text & "'"
                mycmd.CommandText = strSQL
                mycmd.Connection = myconn
                mycmd.ExecuteNonQuery()
                MsgBox("genre Successfully Updated")
                Call Clear_Boxes()
            Catch ex As MySqlException
                MsgBox(ex.Number & " " & ex.Message)
            End Try
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        With Me
            ...
            Try
                ...
                answer = MsgBox("Are you sure you want to delete this genre", MsgBoxStyle.YesNo)
                If answer = MsgBoxResult.Yes Then
                    strSQL = "Delete from genre" _
                                    & " where genre_name = '" _
                                    & .TextBox2.Text & "'"
                    'MsgBox(strSQL)
                    mycmd.CommandText = strSQL
    ...
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim adapter As New MySqlDataAdapter("SELECT * FROM lib_db.genre", connection)
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        Dim table As New DataTable()
        Dim adapter As New MySqlDataAdapter("SELECT * FROM lib_db.genre", myconn)
